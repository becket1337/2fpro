...
namespace _2fpro.Data.Migrations
{
    ...
    [Migration("20181225180750_InitialCreate")]
            ...
            modelBuilder.Entity("_2fpro.Models.Menu", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, IsPublish = false, LastModifiedDate = new DateTime(2018, 12, 25, 21, 7, 50, 94, DateTimeKind.Local), MenuSection = 0, ParentId = 0, SortOrder = 0, Text = "title", Url = "Home" }
                    );
                });
            ...
            modelBuilder.Entity("_2fpro.Models.StaticSection", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 1, Content = "ss", SectionType = 2, Sequance = 1, Title = "static2", Type = 0 },
                        new { ID = 2, Content = "ss", SectionType = 3, Sequance = 2, Title = "static3", Type = 0 },
                        new { ID = 3, Content = "ss", SectionType = 4, Sequance = 3, Title = "static4", Type = 0 },
                        new { ID = 4, Content = "ss", SectionType = 5, Sequance = 4, Title = "static5", Type = 0 },
                        new { ID = 5, Content = "ss", SectionType = 6, Sequance = 5, Title = "static6", Type = 0 }
                    );
                });
