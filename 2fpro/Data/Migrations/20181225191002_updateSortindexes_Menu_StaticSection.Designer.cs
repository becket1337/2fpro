...
namespace _2fpro.Data.Migrations
{
    ...
    [Migration("20181225191002_updateSortindexes_Menu_StaticSection")]
    partial class updateSortindexes_Menu_StaticSection
    {
            ...
            modelBuilder.Entity("_2fpro.Models.Config", b =>
                {
                    ...
                    b.HasData(
                        new { ConfigID = 1, SelectedIsOnlineID = false, SiteName = "sitename" }
                    );
                });
            ...
            modelBuilder.Entity("_2fpro.Models.Menu", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, IsPublish = false, LastModifiedDate = new DateTime(2018, 12, 25, 22, 10, 1, 974, DateTimeKind.Local), MenuSection = 0, ParentId = 0, SortOrder = 0, Text = "title", Url = "Home" }
                    );
                });
            ...
            modelBuilder.Entity("_2fpro.Models.StaticSection", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 1, Content = "ss", SectionType = 2, Sequance = 0, Title = "static2", Type = 0 },
                        new { ID = 2, Content = "ss", SectionType = 3, Sequance = 0, Title = "static3", Type = 0 },
                        new { ID = 3, Content = "ss", SectionType = 4, Sequance = 0, Title = "static4", Type = 0 },
                        new { ID = 4, Content = "ss", SectionType = 5, Sequance = 0, Title = "static5", Type = 0 },
                        new { ID = 5, Content = "ss", SectionType = 6, Sequance = 0, Title = "static6", Type = 0 }
                    );
                });
