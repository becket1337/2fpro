...
{
    public static class SiteHelpFunctions
    {
        ...
        {
            var userAgent = request.Request.UserAgent();
            if ((b.IsMatch(userAgent) || v.IsMatch(userAgent.Substring(0, 4))) || (userAgent.ToLower().Contains("iphone;") || userAgent.ToLower().Contains("ipad;")))
            {
                return true;
            }
        ...
        public static bool IsLocalPath(this HttpRequest req)
        {
            return req.Host.ToString().Contains("localhost");
        }
